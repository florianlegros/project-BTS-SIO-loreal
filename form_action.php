...
if ( !isset($_POST['q1'], $_POST['q2'], $_POST['q3'], $_POST['q4'], $_POST['q5'], $_POST['q6'], $_POST['q7'], $_POST['q8'], $_POST['q9'], $_POST['q10']) ) {
    ...
    if ($stmt = $Bdd->select("idformulaire" ,"formulaire" ,"users_id = '" . $_SESSION['id'] ."'")){
        $stmt->execute();
        $stmt->store_result();
    
        if ($stmt->num_rows > 0) {

            if ($stmt = $Bdd->update('formulaire', "q1='".$_POST['q1']."', q2='".$_POST['q2']."', q3='".$_POST['q3']."', q4='".$_POST['q4']."', q5='".$_POST['q5']."', q6='".$_POST['q6']."', q7='".$_POST['q7']."', q8='".$_POST['q8']."', q9='".$_POST['q9']."', q10='".$_POST['q10']."'","users_id = '" . $_SESSION['id'] ."'")) { 
                $stmt->execute();
